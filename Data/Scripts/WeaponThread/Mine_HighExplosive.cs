...
{ // Don't edit above this line
    ...
    {
        private AmmoDef Mine_HighExplosive_InitialProjectile => new AmmoDef
        {
            AmmoMagazine = "Mine_HighExplosive_Magazine",
            AmmoRound = "Mine - High Explosive",
        ...
        private AmmoDef Mine_HighExplosive => new AmmoDef
        {
            AmmoMagazine = "Mine_HighExplosive_Magazine",
            AmmoRound = "Mine - High Explosive - MineComponent",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 1f,
            Mass = 0f, // in kilograms
            Health = 500f, // 0 = disabled, otherwise how much damage it can take from other trajectiles before dying.
            BackKickForce = 0f,
            DecayPerShot = 0f,
            HardPointUsable = true, // set to false if this is a shrapnel ammoType and you don't want the turret to be able to select it directly.
            IgnoreWater = false,
            ...
            AreaEffect = new AreaDamageDef
            {
                ...
                AreaEffectDamage = 25000f, // 0 = use spillover from BaseDamage, otherwise use this value.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                AccelPerSec = 0f,
                DesiredSpeed = 0,
                MaxTrajectory = 1f, // Cannot be 0 or the projectile is deleted at spawn
                FieldTime = 0, // 0 is disabled, a value causes the projectile to come to rest, spawn a field and remain for a time (Measured in game ticks, 60 = 1 second)
                GravityMultiplier = 0f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable.
                SpeedVariance = Random(start: 0, end: 0), // subtracts value from DesiredSpeed
                RangeVariance = Random(start: 0, end: 0), // subtracts value from MaxTrajectory
            ...
            AmmoGraphics = new GraphicDef
            {
                ModelName = "\\Models\\Mines\\Mine_Placeholder.mwm",
                VisualProbability = 1f,
                ShieldHitDraw = false,
                Particles = new AmmoParticleDef
                {
            ...
            {
                TravelSound = "",
                HitSound = "Mine_Explosion",
                ShieldHitSound = "Mine_Explosion",
                PlayerHitSound = "Mine_Explosion",
                VoxelHitSound = "Mine_Explosion",
                FloatingHitSound = "Mine_Explosion",
                HitPlayChance = 1f,
                HitPlayShield = true,
            }, // Don't edit below this line
            Ejection = new AmmoEjectionDef
